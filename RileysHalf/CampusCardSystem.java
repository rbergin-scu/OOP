...
public class CampusCardSystem extends JFrame implements ActionListener {
	...
	public CampusCardSystem() {
		// TODO fix dataManager using store
		//dm.readFromItems("./src/resources/items.txt");
		//dm.readFromUsers("./src/resources/users.txt");
	...
	private JPanel getActivatePanel() {
		...
		JLabel passwordLabel = new JLabel("Password:");
		panel.add(passwordLabel);
		passwordField2 = new JTextField(8);
		panel.add(passwordField2);
		
		JLabel confirmLabel = new JLabel("Confirm Password:");
		panel.add(confirmLabel);
		confirmField = new JTextField(8);
